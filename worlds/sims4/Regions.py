...
sims4_regions = {
    ...
    "Victory": [
        AspirationNames.base_aspiration_bodybuilder, AspirationNames.base_aspiration_painter_extraordinaire,
        AspirationNames.base_aspiration_bestselling_author, AspirationNames.base_aspiration_musical_genius,
        AspirationNames.base_aspiration_public_enemy, AspirationNames.base_aspiration_chief_of_mischief,
        AspirationNames.base_aspiration_villainous_valentine, AspirationNames.base_aspiration_successful_lineage,
        AspirationNames.base_aspiration_big_happy_family, AspirationNames.base_aspiration_master_chef,
        AspirationNames.base_aspiration_master_mixologist, AspirationNames.base_aspiration_fabulously_wealthy,
        AspirationNames.base_aspiration_mansion_baron, AspirationNames.base_aspiration_renaissance_sim,
        AspirationNames.base_aspiration_computer_whiz, AspirationNames.base_aspiration_nerd_brain,
        AspirationNames.base_aspiration_serial_romantic, AspirationNames.base_aspiration_soulmate,
        AspirationNames.base_aspiration_freelance_botanist, AspirationNames.base_aspiration_angling_ace,
        AspirationNames.base_aspiration_the_curator, AspirationNames.base_aspiration_neighborly_advisor,
        AspirationNames.base_aspiration_joke_star, AspirationNames.base_aspiration_friend_of_the_world,
...
sims4_career_paths = {
    # Astronaut
    CareerNames.base_career_astronaut_2: ["Menu", CareerNames.base_career_astronaut_3],
    CareerNames.base_career_astronaut_3: ["Menu", CareerNames.base_career_astronaut_4],
    CareerNames.base_career_astronaut_4: ["Menu", CareerNames.base_career_astronaut_5],
    CareerNames.base_career_astronaut_5: ["Menu", CareerNames.base_career_astronaut_6],
    CareerNames.base_career_astronaut_6: ["Menu", CareerNames.base_career_astronaut_7],
    CareerNames.base_career_astronaut_7: ["Menu", CareerNames.base_career_astronaut_8A,
                                          CareerNames.base_career_astronaut_8B],
    CareerNames.base_career_astronaut_8A: ["Menu", CareerNames.base_career_astronaut_9A],
    CareerNames.base_career_astronaut_9A: ["Menu", CareerNames.base_career_astronaut_10A],
    CareerNames.base_career_astronaut_8B: ["Menu", CareerNames.base_career_astronaut_9B],
    CareerNames.base_career_astronaut_9B: ["Menu", CareerNames.base_career_astronaut_10B],
    # Athlete
    CareerNames.base_career_athlete_2: ["Menu", CareerNames.base_career_athlete_3],
    CareerNames.base_career_athlete_3: ["Menu", CareerNames.base_career_athlete_4],
    CareerNames.base_career_athlete_4: ["Menu", CareerNames.base_career_athlete_5A,
                                        CareerNames.base_career_athlete_5B],
    CareerNames.base_career_athlete_5A: ["Menu", CareerNames.base_career_athlete_6A],
    CareerNames.base_career_athlete_6A: ["Menu", CareerNames.base_career_athlete_7A],
    CareerNames.base_career_athlete_7A: ["Menu", CareerNames.base_career_athlete_8A],
    CareerNames.base_career_athlete_8A: ["Menu", CareerNames.base_career_athlete_9A],
    CareerNames.base_career_athlete_9A: ["Menu", CareerNames.base_career_athlete_10A],
    CareerNames.base_career_athlete_5B: ["Menu", CareerNames.base_career_athlete_6B],
    CareerNames.base_career_athlete_6B: ["Menu", CareerNames.base_career_athlete_7B],
    CareerNames.base_career_athlete_7B: ["Menu", CareerNames.base_career_athlete_8B],
    CareerNames.base_career_athlete_8B: ["Menu", CareerNames.base_career_athlete_9B],
    CareerNames.base_career_athlete_9B: ["Menu", CareerNames.base_career_athlete_10B],
    # Business
    CareerNames.base_career_business_2: ["Menu", CareerNames.base_career_business_3],
    CareerNames.base_career_business_3: ["Menu", CareerNames.base_career_business_4],
    CareerNames.base_career_business_4: ["Menu", CareerNames.base_career_business_5],
    CareerNames.base_career_business_5: ["Menu", CareerNames.base_career_business_6],
    CareerNames.base_career_business_6: ["Menu", CareerNames.base_career_business_7A,
                                         CareerNames.base_career_business_7B],
    CareerNames.base_career_business_7A: ["Menu", CareerNames.base_career_business_8A],
    CareerNames.base_career_business_8A: ["Menu", CareerNames.base_career_business_9A],
    CareerNames.base_career_business_9A: ["Menu", CareerNames.base_career_business_10A],
    CareerNames.base_career_business_7B: ["Menu", CareerNames.base_career_business_8B],
    CareerNames.base_career_business_8B: ["Menu", CareerNames.base_career_business_9B],
    CareerNames.base_career_business_9B: ["Menu", CareerNames.base_career_business_10B],
    # Criminal
    CareerNames.base_career_criminal_2: ["Menu", CareerNames.base_career_criminal_3],
    CareerNames.base_career_criminal_3: ["Menu", CareerNames.base_career_criminal_4],
    CareerNames.base_career_criminal_4: ["Menu", CareerNames.base_career_criminal_5],
    CareerNames.base_career_criminal_5: ["Menu", CareerNames.base_career_criminal_6A,
                                         CareerNames.base_career_criminal_6B],
    CareerNames.base_career_criminal_6A: ["Menu", CareerNames.base_career_criminal_7A],
    CareerNames.base_career_criminal_7A: ["Menu", CareerNames.base_career_criminal_8A],
    CareerNames.base_career_criminal_8A: ["Menu", CareerNames.base_career_criminal_9A],
    CareerNames.base_career_criminal_9A: ["Menu", CareerNames.base_career_criminal_10A],
    CareerNames.base_career_criminal_6B: ["Menu", CareerNames.base_career_criminal_7B],
    CareerNames.base_career_criminal_7B: ["Menu", CareerNames.base_career_criminal_8B],
    CareerNames.base_career_criminal_8B: ["Menu", CareerNames.base_career_criminal_9B],
    CareerNames.base_career_criminal_9B: ["Menu", CareerNames.base_career_criminal_10B],
    # Culinary
    CareerNames.base_career_culinary_2: ["Menu", CareerNames.base_career_culinary_3],
    CareerNames.base_career_culinary_3: ["Menu", CareerNames.base_career_culinary_4],
    CareerNames.base_career_culinary_4: ["Menu", CareerNames.base_career_culinary_5],
    CareerNames.base_career_culinary_5: ["Menu", CareerNames.base_career_culinary_6A,
                                         CareerNames.base_career_culinary_6B],
    CareerNames.base_career_culinary_6A: ["Menu", CareerNames.base_career_culinary_7A],
    CareerNames.base_career_culinary_7A: ["Menu", CareerNames.base_career_culinary_8A],
    CareerNames.base_career_culinary_8A: ["Menu", CareerNames.base_career_culinary_9A],
    CareerNames.base_career_culinary_9A: ["Menu", CareerNames.base_career_culinary_10A],
    CareerNames.base_career_culinary_6B: ["Menu", CareerNames.base_career_culinary_7B],
    CareerNames.base_career_culinary_7B: ["Menu", CareerNames.base_career_culinary_8B],
    CareerNames.base_career_culinary_8B: ["Menu", CareerNames.base_career_culinary_9B],
    CareerNames.base_career_culinary_9B: ["Menu", CareerNames.base_career_culinary_10B],
    # Entertainer
    CareerNames.base_career_entertainer_2: ["Menu", CareerNames.base_career_entertainer_3],
    CareerNames.base_career_entertainer_3: ["Menu", CareerNames.base_career_entertainer_4],
    CareerNames.base_career_entertainer_4: ["Menu", CareerNames.base_career_entertainer_5A,
                                            CareerNames.base_career_entertainer_5B],
    CareerNames.base_career_entertainer_5A: ["Menu", CareerNames.base_career_entertainer_6A],
    CareerNames.base_career_entertainer_6A: ["Menu", CareerNames.base_career_entertainer_7A],
    CareerNames.base_career_entertainer_7A: ["Menu", CareerNames.base_career_entertainer_8A],
    CareerNames.base_career_entertainer_8A: ["Menu", CareerNames.base_career_entertainer_9A],
    CareerNames.base_career_entertainer_9A: ["Menu", CareerNames.base_career_entertainer_10A],
    CareerNames.base_career_entertainer_5B: ["Menu", CareerNames.base_career_entertainer_6B],
    CareerNames.base_career_entertainer_6B: ["Menu", CareerNames.base_career_entertainer_7B],
    CareerNames.base_career_entertainer_7B: ["Menu", CareerNames.base_career_entertainer_8B],
    CareerNames.base_career_entertainer_8B: ["Menu", CareerNames.base_career_entertainer_9B],
    CareerNames.base_career_entertainer_9B: ["Menu", CareerNames.base_career_entertainer_10B],
    # Painter
    CareerNames.base_career_painter_2: ["Menu", CareerNames.base_career_painter_3],
    CareerNames.base_career_painter_3: ["Menu", CareerNames.base_career_painter_4],
    CareerNames.base_career_painter_4: ["Menu", CareerNames.base_career_painter_5],
    CareerNames.base_career_painter_5: ["Menu", CareerNames.base_career_painter_6],
    CareerNames.base_career_painter_6: ["Menu", CareerNames.base_career_painter_7A,
                                        CareerNames.base_career_painter_7B],
    CareerNames.base_career_painter_7A: ["Menu", CareerNames.base_career_painter_8A],
    CareerNames.base_career_painter_8A: ["Menu", CareerNames.base_career_painter_9A],
    CareerNames.base_career_painter_9A: ["Menu", CareerNames.base_career_painter_10A],
    CareerNames.base_career_painter_7B: ["Menu", CareerNames.base_career_painter_8B],
    CareerNames.base_career_painter_8B: ["Menu", CareerNames.base_career_painter_9B],
    CareerNames.base_career_painter_9B: ["Menu", CareerNames.base_career_painter_10B],
    # Secret Agent
    CareerNames.base_career_secret_agent_2: ["Menu", CareerNames.base_career_secret_agent_3],
    CareerNames.base_career_secret_agent_3: ["Menu", CareerNames.base_career_secret_agent_4],
    CareerNames.base_career_secret_agent_4: ["Menu", CareerNames.base_career_secret_agent_5],
    CareerNames.base_career_secret_agent_5: ["Menu", CareerNames.base_career_secret_agent_6],
    CareerNames.base_career_secret_agent_6: ["Menu", CareerNames.base_career_secret_agent_7],
    CareerNames.base_career_secret_agent_7: ["Menu", CareerNames.base_career_secret_agent_8A,
                                             CareerNames.base_career_secret_agent_8B],
    CareerNames.base_career_secret_agent_8A: ["Menu", CareerNames.base_career_secret_agent_9A],
    CareerNames.base_career_secret_agent_9A: ["Menu", CareerNames.base_career_secret_agent_10A],
    CareerNames.base_career_secret_agent_8B: ["Menu", CareerNames.base_career_secret_agent_9B],
    CareerNames.base_career_secret_agent_9B: ["Menu", CareerNames.base_career_secret_agent_10B],
    CareerNames.base_career_secret_agent_10B: ["Menu", CareerNames.base_career_secret_agent_11B],
    # Style Influencer
    CareerNames.base_career_style_influencer_2: ["Menu", CareerNames.base_career_style_influencer_3],
    CareerNames.base_career_style_influencer_3: ["Menu", CareerNames.base_career_style_influencer_4],
    CareerNames.base_career_style_influencer_4: ["Menu", CareerNames.base_career_style_influencer_5],
    CareerNames.base_career_style_influencer_5: ["Menu", CareerNames.base_career_style_influencer_6A,
                                                 CareerNames.base_career_style_influencer_6B],
    CareerNames.base_career_style_influencer_6A: ["Menu", CareerNames.base_career_style_influencer_7A],
    CareerNames.base_career_style_influencer_7A: ["Menu", CareerNames.base_career_style_influencer_8A],
    CareerNames.base_career_style_influencer_8A: ["Menu", CareerNames.base_career_style_influencer_9A],
    CareerNames.base_career_style_influencer_9A: ["Menu", CareerNames.base_career_style_influencer_10A],
    CareerNames.base_career_style_influencer_6B: ["Menu", CareerNames.base_career_style_influencer_7B],
    CareerNames.base_career_style_influencer_7B: ["Menu", CareerNames.base_career_style_influencer_8B],
    CareerNames.base_career_style_influencer_8B: ["Menu", CareerNames.base_career_style_influencer_9B],
    CareerNames.base_career_style_influencer_9B: ["Menu", CareerNames.base_career_style_influencer_10B],
    # Tech Guru
    CareerNames.base_career_tech_guru_2: ["Menu", CareerNames.base_career_tech_guru_3],
    CareerNames.base_career_tech_guru_3: ["Menu", CareerNames.base_career_tech_guru_4],
    CareerNames.base_career_tech_guru_4: ["Menu", CareerNames.base_career_tech_guru_5],
    CareerNames.base_career_tech_guru_5: ["Menu", CareerNames.base_career_tech_guru_6],
    CareerNames.base_career_tech_guru_6: ["Menu", CareerNames.base_career_tech_guru_7A,
                                          CareerNames.base_career_tech_guru_7B],
    CareerNames.base_career_tech_guru_7A: ["Menu", CareerNames.base_career_tech_guru_8A],
    CareerNames.base_career_tech_guru_8A: ["Menu", CareerNames.base_career_tech_guru_9A],
    CareerNames.base_career_tech_guru_9A: ["Menu", CareerNames.base_career_tech_guru_10A],
    CareerNames.base_career_tech_guru_7B: ["Menu", CareerNames.base_career_tech_guru_8B],
    CareerNames.base_career_tech_guru_8B: ["Menu", CareerNames.base_career_tech_guru_9B],
    CareerNames.base_career_tech_guru_9B: ["Menu", CareerNames.base_career_tech_guru_10B],
    # Writer
    CareerNames.base_career_writer_2: ["Menu", CareerNames.base_career_writer_3],
    CareerNames.base_career_writer_3: ["Menu", CareerNames.base_career_writer_4],
    CareerNames.base_career_writer_4: ["Menu", CareerNames.base_career_writer_5],
    CareerNames.base_career_writer_5: ["Menu", CareerNames.base_career_writer_6A,
                                       CareerNames.base_career_writer_6B],
    CareerNames.base_career_writer_6A: ["Menu", CareerNames.base_career_writer_7A],
    CareerNames.base_career_writer_7A: ["Menu", CareerNames.base_career_writer_8A],
    CareerNames.base_career_writer_8A: ["Menu", CareerNames.base_career_writer_9A],
    CareerNames.base_career_writer_9A: ["Menu", CareerNames.base_career_writer_10A],
    CareerNames.base_career_writer_6B: ["Menu", CareerNames.base_career_writer_7B],
    CareerNames.base_career_writer_7B: ["Menu", CareerNames.base_career_writer_8B],
    CareerNames.base_career_writer_8B: ["Menu", CareerNames.base_career_writer_9B],
    CareerNames.base_career_writer_9B: ["Menu", CareerNames.base_career_writer_10B],
    # Part Time Jobs
    CareerNames.base_ptj_babysitter_2: ["Menu", CareerNames.base_ptj_babysitter_3],
    CareerNames.base_ptj_barista_2: ["Menu", CareerNames.base_ptj_barista_3],
    CareerNames.base_ptj_fastfood_employee_2: ["Menu", CareerNames.base_ptj_fastfood_employee_3],
    CareerNames.base_ptj_manual_laborer_2: ["Menu", CareerNames.base_ptj_manual_laborer_3],
    CareerNames.base_ptj_retail_employee_2: ["Menu", CareerNames.base_ptj_retail_employee_3]
}

sims4_aspiration_milestones = {
    AspirationNames.base_aspiration_basic_trainer: ["Menu", AspirationNames.base_aspiration_exercise_demon],
    AspirationNames.base_aspiration_exercise_demon: ["Menu", AspirationNames.base_aspiration_fit_to_a_t],
    AspirationNames.base_aspiration_fit_to_a_t: ["Menu", AspirationNames.base_aspiration_bodybuilder],
    AspirationNames.base_aspiration_ill_at_easel: ["Menu", AspirationNames.base_aspiration_fine_artist],
    AspirationNames.base_aspiration_fine_artist: ["Menu", AspirationNames.base_aspiration_brushing_with_greatness],
    AspirationNames.base_aspiration_brushing_with_greatness: ["Menu",
                                                              AspirationNames.base_aspiration_painter_extraordinaire],
    AspirationNames.base_aspiration_fledgelinguist: ["Menu", AspirationNames.base_aspiration_competent_wordsmith],
    AspirationNames.base_aspiration_competent_wordsmith: ["Menu", AspirationNames.base_aspiration_novelest_novelist],
    AspirationNames.base_aspiration_novelest_novelist: ["Menu", AspirationNames.base_aspiration_bestselling_author],
    AspirationNames.base_aspiration_tone_deaf: ["Menu", AspirationNames.base_aspiration_fine_tuned],
    AspirationNames.base_aspiration_fine_tuned: ["Menu", AspirationNames.base_aspiration_harmonious],
    AspirationNames.base_aspiration_harmonious: ["Menu", AspirationNames.base_aspiration_musical_genius],
    AspirationNames.base_aspiration_mostly_harmless: ["Menu", AspirationNames.base_aspiration_neighborhood_nuisance,
                                                      AspirationNames.base_aspiration_artful_trickster],
    AspirationNames.base_aspiration_neighborhood_nuisance: ["Menu", AspirationNames.base_aspiration_criminal_mind],
    AspirationNames.base_aspiration_criminal_mind: ["Menu", AspirationNames.base_aspiration_public_enemy],
    AspirationNames.base_aspiration_artful_trickster: ["Menu",
                                                       AspirationNames.base_aspiration_professional_prankster],
    AspirationNames.base_aspiration_professional_prankster: ["Menu",
                                                             AspirationNames.base_aspiration_chief_of_mischief],
    AspirationNames.base_aspiration_readily_a_parent: ["Menu", AspirationNames.base_aspiration_caregiver],
    AspirationNames.base_aspiration_caregiver: ["Menu", AspirationNames.base_aspiration_trusted_mentor,
                                                AspirationNames.base_aspiration_loving_guardian],
    AspirationNames.base_aspiration_trusted_mentor: ["Menu", AspirationNames.base_aspiration_successful_lineage],
    AspirationNames.base_aspiration_loving_guardian: ["Menu", AspirationNames.base_aspiration_big_happy_family],
    AspirationNames.base_aspiration_aluminum_chef: ["Menu", AspirationNames.base_aspiration_captain_cook],
    AspirationNames.base_aspiration_culinary_artist: ["Menu", AspirationNames.base_aspiration_master_chef],
    AspirationNames.base_aspiration_bar_tenderfoot: ["Menu", AspirationNames.base_aspiration_electric_mixer],
    AspirationNames.base_aspiration_electric_mixer: ["Menu", AspirationNames.base_aspiration_beverage_boss],
    AspirationNames.base_aspiration_beverage_boss: ["Menu", AspirationNames.base_aspiration_master_mixologist],
    AspirationNames.base_aspiration_going_for_not_broke: ["Menu", AspirationNames.base_aspiration_learning_earning],
    AspirationNames.base_aspiration_learning_earning: ["Menu", AspirationNames.base_aspiration_welloff],
    AspirationNames.base_aspiration_welloff: ["Menu", AspirationNames.base_aspiration_fabulously_wealthy],
    AspirationNames.base_aspiration_estate_of_the_art: ["Menu", AspirationNames.base_aspiration_the_great_landscaper],
    AspirationNames.base_aspiration_the_great_landscaper: ["Menu", AspirationNames.base_aspiration_home_renovator],
    AspirationNames.base_aspiration_home_renovator: ["Menu", AspirationNames.base_aspiration_mansion_baron],
    AspirationNames.base_aspiration_prudent_student: ["Menu", AspirationNames.base_aspiration_jack_of_some_trades,
                                                      AspirationNames.base_aspiration_erudite],
    AspirationNames.base_aspiration_jack_of_some_trades: ["Menu", AspirationNames.base_aspiration_pantologist],
    AspirationNames.base_aspiration_pantologist: ["Menu", AspirationNames.base_aspiration_renaissance_sim],
    AspirationNames.base_aspiration_erudite: ["Menu", AspirationNames.base_aspiration_rocket_scientist],
    AspirationNames.base_aspiration_rocket_scientist: ["Menu", AspirationNames.base_aspiration_nerd_brain],
    AspirationNames.base_aspiration_with_the_program: ["Menu", AspirationNames.base_aspiration_technically_adept],
    AspirationNames.base_aspiration_technically_adept: ["Menu", AspirationNames.base_aspiration_computer_geek],
    AspirationNames.base_aspiration_computer_geek: ["Menu", AspirationNames.base_aspiration_computer_whiz],
    AspirationNames.base_aspiration_amore_amateur: ["Menu", AspirationNames.base_aspiration_up_to_date,
                                                    AspirationNames.base_aspiration_marriage_material],
    AspirationNames.base_aspiration_up_to_date: ["Menu", AspirationNames.base_aspiration_romance_juggler],
    AspirationNames.base_aspiration_romance_juggler: ["Menu", AspirationNames.base_aspiration_serial_romantic],
    AspirationNames.base_aspiration_marriage_material: ["Menu", AspirationNames.base_aspiration_love_handler],
    AspirationNames.base_aspiration_love_handler: ["Menu", AspirationNames.base_aspiration_soulmate],
    AspirationNames.base_aspiration_naturewalker: ["Menu", AspirationNames.base_aspiration_garden_variety],
    AspirationNames.base_aspiration_garden_variety: ["Menu", AspirationNames.base_aspiration_nature_nurturer],
    AspirationNames.base_aspiration_nature_nurturer: ["Menu", AspirationNames.base_aspiration_freelance_botanist],
    AspirationNames.base_aspiration_out_and_about: ["Menu", AspirationNames.base_aspiration_gatherer],
    AspirationNames.base_aspiration_gatherer: ["Menu", AspirationNames.base_aspiration_treasure_hunter],
    AspirationNames.base_aspiration_treasure_hunter: ["Menu", AspirationNames.base_aspiration_the_curator],
    AspirationNames.base_aspiration_fish_out_of_water: ["Menu", AspirationNames.base_aspiration_hooked],
    AspirationNames.base_aspiration_hooked: ["Menu", AspirationNames.base_aspiration_reel_smart],
    AspirationNames.base_aspiration_reel_smart: ["Menu", AspirationNames.base_aspiration_angling_ace],
    AspirationNames.base_aspiration_practical_joker: ["Menu", AspirationNames.base_aspiration_standup_startup],
    AspirationNames.base_aspiration_standup_startup: ["Menu", AspirationNames.base_aspiration_funny],
    AspirationNames.base_aspiration_funny: ["Menu", AspirationNames.base_aspiration_joke_star],
    AspirationNames.base_aspiration_new_in_town: ["Menu", AspirationNames.base_aspiration_welcoming_host,
                                                  AspirationNames.base_aspiration_well_liked],
    AspirationNames.base_aspiration_welcoming_host: ["Menu", AspirationNames.base_aspiration_sir_gala_had],
    AspirationNames.base_aspiration_sir_gala_had: ["Menu", AspirationNames.base_aspiration_party_animal],
    AspirationNames.base_aspiration_well_liked: ["Menu", AspirationNames.base_aspiration_super_friend],
    AspirationNames.base_aspiration_super_friend: ["Menu", AspirationNames.base_aspiration_friend_of_the_world]
}
